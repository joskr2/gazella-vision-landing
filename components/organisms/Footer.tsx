        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8 items-start lg:items-center justify-between">
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <motion.a
                href={`https://wa.me/${siteConfig.phoneNumber}?text=${encodeURIComponent("¡Hola! Tengo algunas preguntas sobre el programa Gazella Vision. ¿Podrían ayudarme con más información?")}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-gray-400 hover:text-gray-200 transition-colors py-1 group"
                whileHover={{ x: 5 }}
              ...
              >
                ...
                <span>Josue Patricio Retamozo Vargas</span>
              </motion.a>
            </div>
          </motion.div>
        </div>
